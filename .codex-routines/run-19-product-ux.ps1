...
$LockPath = "D:\helper\.codex-routines\locks\19-product-ux.lock"
$PromptPath = "D:\helper\.codex-routines\19-product-ux.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"

Set-Location $Project

$Stamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$LogFile = "$LogDir\19-product-ux-$Stamp.log"
...
Write-Log "==== Helper Codex Routine: 19-product-ux ===="
