...
$PromptPath = "D:\helper\.codex-routines\19-product-ux-feature.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"
$LogFile = "$LogDir\19-product-ux-feature-$Stamp.log"

New-Item -ItemType Directory -Force $LogDir | Out-Null

"==== Helper Codex Routine: 19-product-ux-feature ====" | Tee-Object -FilePath $LogFile -Append
