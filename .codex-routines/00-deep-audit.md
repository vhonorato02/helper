...
Rotina 00h: Deep Audit.
Auditar stack, dependências, arquitetura, banco, segurança, performance, acessibilidade, PWA, testes, build e produção. Corrigir problemas seguros. Atualizar apenas versões stable compatíveis. Testar no navegador real.
