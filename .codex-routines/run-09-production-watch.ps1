...
$PromptPath = "D:\helper\.codex-routines\09-production-watch.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"
$LogFile = "$LogDir\09-production-watch-$Stamp.log"

New-Item -ItemType Directory -Force $LogDir | Out-Null

"==== Helper Codex Routine: 09-production-watch ====" | Tee-Object -FilePath $LogFile -Append
