...
$PromptPath = "D:\helper\.codex-routines\16-e2e-tests.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"
$LogFile = "$LogDir\16-e2e-tests-$Stamp.log"

New-Item -ItemType Directory -Force $LogDir | Out-Null

"==== Helper Codex Routine: 16-e2e-tests ====" | Tee-Object -FilePath $LogFile -Append
