...
$LockPath = "D:\helper\.codex-routines\locks\00-engineering-audit.lock"
$PromptPath = "D:\helper\.codex-routines\00-engineering-audit.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"

Set-Location $Project

$Stamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$LogFile = "$LogDir\00-engineering-audit-$Stamp.log"
...
Write-Log "==== Helper Codex Routine: 00-engineering-audit ===="
