...
$LockPath = "D:\helper\.codex-routines\locks\23-daily-report.lock"
$PromptPath = "D:\helper\.codex-routines\23-daily-report.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"

Set-Location $Project

$Stamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$LogFile = "$LogDir\23-daily-report-$Stamp.log"
...
Write-Log "==== Helper Codex Routine: 23-daily-report ===="
