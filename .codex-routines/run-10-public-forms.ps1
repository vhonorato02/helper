...
$PromptPath = "D:\helper\.codex-routines\10-public-forms.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"
$LogFile = "$LogDir\10-public-forms-$Stamp.log"

New-Item -ItemType Directory -Force $LogDir | Out-Null

"==== Helper Codex Routine: 10-public-forms ====" | Tee-Object -FilePath $LogFile -Append
