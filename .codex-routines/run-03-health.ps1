...
$LockPath = "D:\helper\.codex-routines\locks\03-health.lock"
$PromptPath = "D:\helper\.codex-routines\03-health.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"

Set-Location $Project

$Stamp = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$LogFile = "$LogDir\03-health-$Stamp.log"
...
Write-Log "==== Helper Codex Routine: 03-health ===="
