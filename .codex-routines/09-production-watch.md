...
Rotina 09h: Observador de Produção.
Abrir produção no navegador real, testar rotas principais, página pública, login quando possível, dashboard, tickets, reservas e console. Corrigir se houver falha.
