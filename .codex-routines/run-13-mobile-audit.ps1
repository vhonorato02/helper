...
$PromptPath = "D:\helper\.codex-routines\13-mobile-audit.md"
$Codex = "C:\Users\Anglo\AppData\Local\OpenAI\Codex\bin\716dda49c14d31a0\codex.exe"
$LogFile = "$LogDir\13-mobile-audit-$Stamp.log"

New-Item -ItemType Directory -Force $LogDir | Out-Null

"==== Helper Codex Routine: 13-mobile-audit ====" | Tee-Object -FilePath $LogFile -Append
